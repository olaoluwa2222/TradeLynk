...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* MOBILE VIEW - Product-first experience (< 768px) */}
      ...
      {/* DESKTOP VIEW - Full experience (>= 768px) */}
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-lg p-8 hover:bg-white/20 transition-all duration-300 border border-white/20">
                ...
                >
                  Every seller gets a personalized mini-website with home,
                  about, products, and contact sections. Build your brand within
                  our platform.
                </p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-lg p-8 hover:bg-white/20 transition-all duration-300 border border-white/20">
                ...
                >
                  Don't have a website? No problem! TradeLynk gives you
                  everything you need to sell online—instantly and
                  professionally.
                </p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-lg p-8 hover:bg-white/20 transition-all duration-300 border border-white/20">
                ...
                >
                  Connect directly with sellers. No middleman fees, just
                  authentic relationships and fair prices for quality products.
                </p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-lg p-8 hover:bg-white/20 transition-all duration-300 border border-white/20">
                ...
                >
                  Built-in chat system. Message sellers directly and ask
                  questions instantly.
                </p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-lg p-8 hover:bg-white/20 transition-all duration-300 border border-white/20">
                ...
                >
                  Shop from sellers worldwide or sell to a global audience.
                  Break geographical barriers and expand your reach
                  effortlessly.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
              ...
              <div className="flex flex-col items-center">
                ...
                >
                  ...
                  thousands of listings across diverse categories, updated
                  daily.
                </p>
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center space-y-8">
              ...
              <div>
                ...
                >
                  Join <span className="text-white font-bold">thousands</span>{" "}
                  of sellers already building their brands and reaching
                  customers worldwide
                </p>
              </div>
